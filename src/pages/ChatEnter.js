                ...
                <Grid container style={{backgroundImage: `url(${bg})`,backgroundOverlay:"black",width:"85%",backgroundPosition:"center",backgroundSize:"100%"}}>
                    <Grid container style={{justifyContent: 'center',backgroundColor:"rgba(255, 255, 255, 0.85)",}}>
                        <Grid container item style={{justifyContent: 'center'}} >
                            <Grid container item style={{height:520,width:350, border: "1px solid black",borderRadius:10,paddingBottom:50}}>
                                <Grid container item style={{height:56,backgroundColor:themeX.palette.primary.main,borderTopLeftRadius:10,borderTopRightRadius:10,justifyContent:'center'}}>

                                    <Typography variant='h5' style={{fontFamily:'Comic Sans MS',color:'white',fontWeight:'bold',paddingTop:16}}>
                                        Welcome to ChatBot
                                ...
                                <Grid container item style={{justifyContent:'center'}} >
                                    ...
                                    <Grid item md={6}>
                                        <Typography variant="h5"  style={{fontFamily:'Comic Sans MS'}}>
                                            <Typography variant="h6"  lign="center" style={{fontFamily:'Comic Sans MS'}}>
                                                I'm Chatty
