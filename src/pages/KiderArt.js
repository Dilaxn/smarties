                ...
                <Grid item container style={{paddingTop: 40}}>
                    <Grid container onClick={
                        () => {
                            history.push({
                                pathname: '/letStart',
                                state: {detail: '/drawFruitTimeline',val:['Draw an apple','Draw an apple','Draw an apple',
                                        'Draw an apple','Draw an apple']}
                            })
                    ...
                    <Grid container onClick={
                        () => {
                            history.push({
                                pathname: '/letStart',
                                state: {detail: '/drawFruitTimeline',val:['Draw an circle','Draw an circle','Draw an circle',
                                        'Draw an circle','Draw an circle']}
                            })
                    ...
                    <Grid container onClick={
                        () => {
                            history.push({
                                pathname: '/letStart',
                                state: {detail: '/drawFruitTimeline',val:['Draw an cat','Draw an cat','Draw an cat',
                                        'Draw an cat','Draw an cat']}
                            })
