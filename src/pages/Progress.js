        ...
        <Container>
            ...
            <Grid item container style={{paddingTop:40}} >
                <Grid container item style={{justifyContent:"center" }} md={4}>
                    ...
                    <Typography  align="center" style={{  maxWidth: "100%",margin:15,opacity:0.6 ,fontFamily:"Comic Sans MS",fontStyle:"italic", fontSize:35}} >Kinder Art</Typography>
                ...
                <Grid container  item style={{justifyContent:"center" }} md={4}>
                    ...
                    <Typography  align="center" style={{  maxWidth: "100%",margin:15,opacity:0.6 ,fontFamily:"Comic Sans MS",fontStyle:"italic", fontSize:35}} >Talk with Smart'es</Typography>
                ...
                <Grid container  item style={{justifyContent:"center" }} md={4}>
                    ...
                    <Typography  align="center" style={{  maxWidth: "100%",margin:15,opacity:0.6 ,fontFamily:"Comic Sans MS",fontStyle:"italic", fontSize:35}} >Play with math</Typography>
